...
// lastly set the port
  ...
  export const DATABASE_URL = process.env.PORT ? process.env.DATABASE_URL: "mongodb+srv://omeiza:ESx6Pmxqa925j5XI@cluster0.f5hzq.mongodb.net/?retryWrites=true&w=majority";
